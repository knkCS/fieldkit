...
export function ReferenceField({ field, readOnly }: FieldProps<ReferenceSettings>) {
    ...
    <div style={{ marginBottom: "1rem" }}>
      ...
      <Controller
        ...
        render={({ field: formField, fieldState }) => {
          ...
          }, [currentIds.join(",")]); // eslint-disable-line react-hooks/exhaustive-deps
          ...
          const handleAdd = (item: ReferenceItem) => {
            if (isSingle) {
              ...
              const arr = Array.isArray(formField.value) ? [...formField.value] : [];
          ...
          const handleRemove = (id: string) => {
            if (isSingle) {
              ...
              const arr = Array.isArray(formField.value) ? formField.value.filter((v: string) => v !== id) : [];
              formField.onChange(arr);
            }
          };
