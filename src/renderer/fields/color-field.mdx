...
Demonstrates the `default_color` setting. Note: `default_color` is currently unused by the component — it does not pre-fill the picker.

<Canvas of={Stories.WithDefaultColor} />
