...
describe("textareaPlugin", () => {
  ...
  it("should generate required string Zod type", () => {
    const field: Field = {
      field_type: "textarea",
      config: { name: "Description", api_accessor: "description", required: true, instructions: "" },
      settings: null,
      children: null,
      system: false,
    };
  ...
  it("should generate optional string Zod type", () => {
    const field: Field = {
      field_type: "textarea",
      config: { name: "Notes", api_accessor: "notes", required: false, instructions: "" },
      settings: null,
      children: null,
      system: false,
    };
  ...
  it("should respect min/max length validation", () => {
    const field: Field = {
      field_type: "textarea",
      config: { name: "Bio", api_accessor: "bio", required: false, instructions: "" },
