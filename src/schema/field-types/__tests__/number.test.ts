...
describe("numberPlugin", () => {
  ...
  it("should generate number Zod type", () => {
    const field: Field = {
      field_type: "number",
      config: { name: "Age", api_accessor: "age", required: false, instructions: "" },
      settings: null,
      children: null,
      system: false,
    };
  ...
  it("should respect max setting", () => {
    const field: Field = {
      field_type: "number",
      config: { name: "Score", api_accessor: "score", required: false, instructions: "" },
      settings: { max: 100 },
      children: null,
      system: false,
    };
  ...
  it("should respect both min and max settings", () => {
    const field: Field = {
      field_type: "number",
      config: { name: "Rating", api_accessor: "rating", required: false, instructions: "" },
