...
import type { FieldTypePlugin, FieldProps, CellProps } from "../../schema/plugin";
...
describe("SpecDataTable", () => {
  it("should render column headers from schema", () => {
    render(
      <SpecDataTable schema={schema} data={data} plugins={plugins} />,
    );
  ...
  it("should handle empty data", () => {
    render(
      <SpecDataTable schema={schema} data={[]} plugins={plugins} />,
    );
