...
describe("FieldModal", () => {
  it("renders with field data populated", () => {
    ...
    expect(screen.getByTestId("field-accessor-input")).toHaveValue("first_name");
    expect(screen.getByTestId("field-required-input")).toBeChecked();
    expect(screen.getByTestId("field-instructions-input")).toHaveValue("Enter your first name");
  ...
  it("auto-generates api_accessor from name", () => {
    ...
    expect(screen.getByTestId("field-accessor-input")).toHaveValue("my_field_name");
  });
  ...
  it("shows error for duplicate accessor", () => {
    ...
    expect(screen.getByText("This accessor is already in use")).toBeInTheDocument();
  });
